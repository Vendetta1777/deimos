...
class Config:
    ...
    system_prompt: str = (
        ...
        "You can control the Mac's system with the mac_control tool: lock the "
        "screen, sleep, dark/light mode, mute/unmute, empty trash, take a "
        "screenshot, keep awake, hide other apps, quit an app (value = app name), "
